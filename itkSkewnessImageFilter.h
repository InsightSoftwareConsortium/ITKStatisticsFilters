 ...
 *
 *=========================================================================*/
#ifndef itkSkewnessImageFilter_h
#define itkSkewnessImageFilter_h
 ...
 *
 * \wiki
 * \wikiexample{Statistics/SkewnessImageFilter,Compute the local noise in an image}
 * \endwiki
 */
...
public:
  ...
  typedef SkewnessImageFilter                                  Self;
  ...
  itkTypeMacro(SkewnessImageFilter, StandardizedMomentImageFilter);
...
protected:
  SkewnessImageFilter();
  virtual ~SkewnessImageFilter() {}

  /** SkewnessImageFilter can be implemented as a multithreaded filter.
...
private:
  SkewnessImageFilter(const Self &) ITK_DELETE_FUNCTION;
  void operator=(const Self &) ITK_DELETE_FUNCTION;
};
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkSkewnessImageFilter.hxx"
#endif
